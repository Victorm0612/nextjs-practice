...
async function getStaticProps() {
  //fetch data from an API
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://victor-vargas:V7UMp62gmecIT81F@cluster0.61lye.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
